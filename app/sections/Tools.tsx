...
import {
    ...
    SiAdobeillustrator,
    SiAdobephotoshop, SiAstro, SiCinema4D, SiCodepen, SiCplusplus, SiFigma, SiFramer, SiGit,
    SiGithub,
    SiGooglechrome, SiGooglefonts,
    SiIntellijidea, SiJavascript, SiKotlin, SiLua,
    SiNeovim, SiNextdotjs, SiReact, SiRust, SiTypescript, SiUbisoft, SiUnity, SiUnrealengine, SiWebstorm, SiZig
} from "react-icons/si";
        ...
        >
            <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
                ...
                <div className="mx-auto w-[100%] lg:max-w-[1200px] justify-center">
                    ...
                    <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-bold leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[40px] md:leading-relaxed lg:mb-16 lg:w-[50%]">
                        <AnimatedBody delay={0.3} text="Game Developement" />
                        <div>
